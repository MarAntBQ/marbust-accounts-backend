<?php
MarbustController::AccountsChangeDataController();
?>
<div class="section change-data-container">
    <h1 class="pt10px pb15px">Cambiar mis Datos</h1>
    <p class="tac lh2em fs20px fs-m-19px fs-p-18px mauto w80p">Por favor use el siguiente formulario para realizar el cambio de sus datos</p>
    <?php
    ...
    <div class="flex-s-a mt30px mb30px">
        <div class="box-8 box-m-12 flex-s-a">
            <form method="post">
                ...
                <input type="hidden" name="controller-action" value="changeData">
            </form>
        </div>
    </div>
