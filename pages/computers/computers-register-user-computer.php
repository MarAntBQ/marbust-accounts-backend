<?php
 MarbustController::SpecificCustomerRegisterPCController();
?>
<div class="section register-computer-container">
    <h1 class="pt10px pb15px">Registrar Computadora de Cliente</h1>
   ...
   <?php
    ...
    <div class="flex-s-a mt30px mb30px">
        <div class="box-8 box-m-12 flex-vcc flex-hc">
            <form method="post">
               <p class="fs18px mb5px"><span>*</span> Cliente:</p>
               <select name="RegisterUserId">
               <?php
