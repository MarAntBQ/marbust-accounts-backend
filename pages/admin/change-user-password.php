<?php
MarbustController::AccountsChangePasswordUserController($_SESSION['USERIDTOCHANGE']);
?>
<div class="section change-password-container">
	<h1 class="pt10px pb15px">Cambiar Mi Contraseña en el Sitio</h1>
	<p class="tac lh2em fs20px fs-m-19px fs-p-18px mauto w80p">Por favor use el siguiente formulario para realizar el cambio de los Password de: <strong><?php echo $_SESSION['USERTOCHANGE']['accountName']?></strong></p>
	<?php
	...
	<div class="flex-s-a mt30px mb30px">
		<div class="box-8 box-m-12 flex-s-a">
			<form method="post">
				...
				<input type="hidden" name="controller-action" value="changeUserPassword">
			</form>
		</div>
	</div>
</div>
